...
const Connexion = () => {
  ...
  useEffect(() => {
    try {
      ...
      const handleCanPlay = () => {
        setAudioReady(true);
        console.log("Audio prêt à être joué (Connexion)");
      };
  ...
  // Gestion du clic sur les boutons d'affichage/masquage de mot de passe
  const handleTogglePassword = (setter) => {
    return () => {
      playClickSound();
      setter(prev => !prev);
    };
      ...
      {alert && (
        <div className={`global-alert alert-${alert.type}`}>
          <div className="alert-content">
            ...
            <button 
              className="alert-close"
              onClick={handleWithSound(() => setAlert(null))}
            >
              ×
            </button>
          </div>
        ...
        <div className="form-footer">
          <p className="text1">
            ...
            <Link 
              ...
              onClick={handleWithSound(() => setIsTransitioning(true))}
            >
              S'inscrire
            </Link>
          </p>
        ...
        {!isForgotPassword ? (
          <>
            ...
            <form className="auth-form" onSubmit={loginUser}>
              ...
              <button type="submit" className="btn1" onClick={playClickSound}>
                Se connecter <AiOutlineSwapRight className="icon3" />
              </button>
              <div className="forgot-link">
                <p 
          ...
          <>
            ...
            {step === 1 && (
              <form onSubmit={handleSendCode} className="auth-form">
                ...
                <button type="submit" disabled={loading} className="btn1" onClick={playClickSound}>
                  {loading ? "Envoi en cours..." : "Envoyer le code"}
                </button>
                <button 
                  type="button"
                  className="back-btn" 
                  onClick={handleWithSound(() => { 
                    setIsForgotPassword(false); 
                    setStep(1); 
                    setMessage(''); 
                    setCode(['', '', '', '', '', '']); 
            ...
            {step === 2 && (
              <form onSubmit={verifyCode} className="auth-form">
                ...
                <button 
                  ...
                  onClick={handleWithSound(() => setStep(1))}
                >
                  Changer d'email
                </button>
              </form>
            ...
            {step === 3 && (
              <form onSubmit={handleResetPassword} className="auth-form">
                ...
                <div className="form-group">
                  ...
                  <div className="input-container password-container">
                    ...
                    <button 
                      type="button"
                      className="password-toggle"
                      onClick={handleTogglePassword(setShowNewPassword)}
                    >
                      {showNewPassword ? <FaEyeSlash /> : <FaEye />}
                    </button>
                  </div>
                ...
                <button 
                  type="button" 
                  className="btn-cancel" 
                  onClick={handleWithSound(() => setStep(2))}
                >
                  Retour au connexion
                </button>
              </form>
